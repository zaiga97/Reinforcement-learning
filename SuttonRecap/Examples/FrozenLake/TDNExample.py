...
if __name__ == '__main__':
    ...
    alpha_gen = ExpDecayParameter(0.25, 2000)
    alpha_sarsa = ExpDecayParameter(0.1, 2000)
    epsilon = ExpDecayParameter(1, 2000)
    gamma = 0.99

    tdn = GeneralizedTDN(alpha=alpha_gen, gamma=gamma, epsilon=epsilon, env=env, n=4, sigma=0.5)
    tdn_sarsa = TDNSarsa(alpha=alpha_sarsa, gamma=gamma, epsilon=epsilon, env=env, n=4)
